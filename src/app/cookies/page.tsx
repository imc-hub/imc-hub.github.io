...
const sections = [
  {
    ...
    content: [
      ...
      "This Cookie Declaration explains how IMC Inc. ('IMC,' 'we,' 'us,' or 'our') uses cookies and similar tracking technologies on our platform, including the IMC website, IMC Academy, Corporate Simulator, and related services (collectively, the 'Service'). It should be read alongside our Privacy Policy, available at /privacy.",
    ],
  },
  {
    id: "why-cookies",
  ...
  },
  {
    ...
    content: [
      ...
      "You may withdraw your consent to non-essential cookies at any time. Withdrawing consent does not affect the lawfulness of processing based on consent before its withdrawal. To withdraw or update your cookie preferences, use the cookie preference center accessible via the link in the footer of any page, or contact us at privacy@imc-hub.com.",
      ...
      <section className="bg-secondary/30 py-12 sm:py-16">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-xs text-muted-foreground">
            ...
            <a
              href="mailto:privacy@imc-hub.com"
